...
$nro=$db->GetOne("select max(nro)+1 from plato");
...
<!--proveedor-->
          <div class="row">
            ...
            <div class="col-md-2">
              ...
              <input type="text" name="nombreplato" id="nombreplato" class="form-control"
              placeholder="Nombre del nuevo plato" >
            </div>
             <div class="col-md-2">
              <label>Precio del Plato:</label>
             <div class="input-group">
              <input type="number" step="0.001" name="p_uni" id="p_uni" placeholder="Bs." class="form-control" onkeypress="return validar(event)">
                 </div>
            </div>  
            <div class="col-md-2">
              <label>Precio Delivery:</label>
             <div class="input-group">
              <input type="number" step="0.001" name="p_delivery" id="p_delivery" placeholder="Bs." class="form-control" onkeypress="return validar(event)">
                 </div>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
              <label>Costo:</label>
             <div class="input-group">
              <input type="number" step="0.001" name="costo" id="costo" placeholder="Bs." class="form-control" onkeypress="return validar(event)">
                 </div>
            </div>
...
<!--fin de proveedor-->
          <div class="row">
            ...
            <div class="col-md-2">
              <label>Cantidad insumo x plato :</label>
