...
<table id="example" class="table table-responsive table-striped table-bordered table-hover" cellspacing="" width="100px">
      ...
      <!--  <tfoot>
        ...
        <tbody>
<?php $c=0; $total=0; $totaldescuento=0; $descuento=0; $total2=0;foreach ($query as $r){ $c=$c+1; if($r["estado"]!="A"){$total=$total+$r["total"];}else{$total2=$total2+$r["total"];}?>
  <tr class=warning>
      <td><?php echo "3"; ?></td>
      <td><?php echo $c; ?></td>
