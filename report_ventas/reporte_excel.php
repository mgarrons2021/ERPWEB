...
$sucur=$_POST['selec_sucur'];
$min=$_POST['fechaini'];
$max=$_POST['fechamax'];
$resultado=$db->GetRow("select * from venta where sucursal_id='$sucur' and v.fecha between '$min' and '$max'");
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B6', 'NO. NIT/CI DEL COMPRADOR');
	$objPHPExcel->getActiveSheet()->getColumnDimension('C')->setWidth(10);
	$objPHPExcel->getActiveSheet()->setCellValue('C6', 'NO. FACTURA');
	$objPHPExcel->getActiveSheet()->getColumnDimension('D')->setWidth(10);
	$objPHPExcel->getActiveSheet()->setCellValue('D6', 'NO. AUTORIZACION');
