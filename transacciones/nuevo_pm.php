...
<form class="form-horizontal" data-toggle="validator" name="elformulario"  role="" action="agregar.php" method="post">
    <h2>registro de transacciones por Hora <br> <?php echo $sucursal;?> <br>Turno PM</h2>
      <input type="hidden" name="idusuario" id="idusuario" value="<?php echo "$idusuario"; ?>">
       <input type="hidden" name="idsucursal" id="idsucursal" value="<?php echo "$sucursal_id"; ?>">
       <input type="hidden" name="turno" id="turno" value="PM">
         ...
         <div class="col-md-12">
          <label class="col-md-5 control-label">04:00 - 05:00 PM:</label>  
            <div class="col-md-2">
            <input id="hora1" type="decimal" name="hora1" class="form-control input-md" placeholder="T.T." pattern="[z0-9_.]{1,15}">
          </div>
         </div>

 <div class="col-md-12">
            <label class="col-md-5 control-label">05:00 - 06:00 PM:</label>  
            <div class="col-md-2">
            ...
            <div class="col-md-12" >
            <label class="col-md-5 control-label">06:00 - 07:00 PM:</label>  
            <div class="col-md-2">
            ...
            <div class="col-md-12">
            <label class="col-md-5 control-label">07:00 - 08:00 PM:</label>  
            <div class="col-md-2">
            ...
            <div class="col-md-12">
            <label class="col-md-5 control-label">08:00 - 09:00 PM:</label>  
            <div class="col-md-2">
            ...
            <div class="col-md-12">
            <label class="col-md-5 control-label">09:00 - 10:00 PM:</label>  
            <div class="col-md-2">
            ...
            <div class="col-md-12">
            <label class="col-md-5 control-label">10:00 - 11:00 PM:</label>  
            <div class="col-md-2">
           ...
           <div class="col-md-12">
            <label class="col-md-5 control-label">11:00 - 12:00 PM:</label>  
            <div class="col-md-2">
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-2">
            <input id="hora9" type="decimal" name="hora9" class="form-control input-md" placeholder="T.T." pattern="[z0-9_.]{1,15}" >
            </div>
