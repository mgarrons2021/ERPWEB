...
/////////modificacion del nro de factura
...
<div class="jumbotron">
  ...
  <p class="lead">
  <?php
   echo "<a class='btn btn-primary btn-lg' href='pdfventa.php?idturno=$idturno&nro=$nro' target='_blank' role='button'>Imprimir Baucher</a>";
   echo " ";
   echo "<a class='btn btn-primary btn-lg' href='nuevo.php' role='button'>Nueva venta</a>";
   echo " ";
   echo "<a class='btn btn-primary btn-lg' href='pdffactura2.php?idturno=$idturno&nro=$nro' target='_blank' role='button'>Imprimir </a>";
   ?>
  </p>
</div>
</div>
