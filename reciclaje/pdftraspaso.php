...
where  dt.nro = $nro and p.idunidad_medida=u.idunidad_medida and p.idproducto = dt.producto_id and dt.sucursal_id=".$usuario['sucursal_id']);
$pdf = new fpdf();
$pdf->addpage();
$pdf->setFont('Arial','B',12);
$pdf->Image('../images/logofactura.jpg',10,5,80,30,'jpg');
$pdf->Ln(3);
$pdf->Cell(0,0,'Lista de Traspasos',0,0,'R');
$pdf->setFont('Arial','',12);
$pdf->Ln(5);
$pdf->Cell(0,0,'Nro # '.$nro ,0,0,'R');
$pdf->Ln(5);
