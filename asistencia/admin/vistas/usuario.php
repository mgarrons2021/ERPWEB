...
-->   
      <div class="from-group col-lg-6 col-md-6 col-xs-12">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <select name="turno" id="turno" class="form-control select-picker">
      
     </select>
     </div>
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Fecha de Contrato(*):</label>
     <input name="fecha_contrato" id="fecha_contrato" class="form-control" type=date>
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Fecha Fin Contrato(*):</label>
     <select name="iddepartamento" id="iddepartamento" class="form-control select-picker" required>
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <input name="numero_celular" id="numero_celular" class="form-control" type="text">
      
     
    </div>
      <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Salario(*):</label>
     <input name="iddepartamento" id="iddepartamento" class="form-control" type="text">
