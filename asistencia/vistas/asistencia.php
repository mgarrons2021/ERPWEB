...
<html>
  <head>
    ...
    <title>ERPWEB DONESCO S.R.L.</title>
...
<?php 
 //include '../ajax/asistencia.php' ?>
  ...
  <div class="lockscreen-item">
    ...
    <form  action="" class="lockscreen-credentials" name="formulario" id="formulario" method="POST">
      <div class="input-group">
        <input type="password" class="form-control" name="codigo_persona" id="codigo_persona" placeholder="Codigo de asistencia">
  ...
  <div class="help-block text-center">
    Ingresa tu codigo de asistencia
  </div>
