...
$query2 = $produtos;
$query3= $db->GetRow("select * from pre_pla where plato_id='$idplato'");
...
function nro_factura(){$.post('nro_factura.php',function(valor){
  $('#nro_factura').val(valor);}
    ...
    $('#listado').load('listar.php',{"idpre_pla":$('#idpre_pla').val()
    });} 
      ...
      alert("ingrese cantidad valida");$("#cantidad").focus();return false;}
             ...
             alertify.success('Producto Agregado Exitosamente');
              ...
              {"idprod":$('#idprod').val(),
                ...
                "idpre_pla":$('#idpre_pla').val(),
                "imagen":$('#imagen').val()
              });
               return true;
              }
function eliminar(id){$.post('eliminar.php',{"idpre_pla":id},
function(){
  listar();
}
  );}
          ...
          <div class="row">
              <div class="col-md-1">
               ...
               <input type="text" name="nro" id="nro" class="alert alert-success"
                 ...
                 value="<?php echo "$nro"; ?>">
                 <input type="hidden" name="plato_id" id="plato_id" class="form-control"
...
<!--proveedor-->
          <div class="row">
            ...
            <div class="col-md-2">
              ...
              <input type="text" name="plato_id" id="plato_id" class="form-control" placeholder="Nombre del plato" value="<?php echo $query3["plato_id"]; ?>">
            </div>
             <div class="col-md-2">
              <label>Precio del Plato:</label>
             <div class="input-group">
              <input type="text" step="0.001" name="precio" id="precio" placeholder="Bs." class="form-control" onkeypress="return validar(event)" value="<?php echo $query3["precio"]; ?>">
                 </div>
            </div>  
            <div class="col-md-2">
              <label>Precio Delivery:</label>
             <div class="input-group">
              <input type="text" step="0.001" name="precio_d" id="precio_d" placeholder="Bs." class="form-control" onkeypress="return validar(event)" value="<?php echo $query3["precio_d"]; ?>">
                 </div>
            </div>
            <div class="col-md-2">
              <label>Sucursal:</label>
             <div class="input-group">
              <input type="text" step="0.001" name="sucursal_id" id="sucursal_id" placeholder="Bs." class="form-control" onkeypress="return validar(event)" value="<?php echo $query3["sucursal_id"]; ?>">
                 </div>
            </div>
            <div class="col-md-2">
