        ...
        <div class="left-sidebar">
            ...
            <div class="table-responsive">
                ...
                if (isset($_POST['fechaini']) && isset($_POST['fechamax'])) {
                    ...
                    $sql_am_sur = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE pago != 'comida_personal' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 2  AND turno = 1 AND estado = 'V' GROUP BY fecha");
                    $sql_pm_sur = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE pago != 'comida_personal' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 2  AND turno = 2 AND estado = 'V' GROUP BY fecha");
                    $sql_sur_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE  pago != 'comida_personal' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 2 AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_sur = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 2 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_sur = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 2 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_sur = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 2 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_trespasos_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 5 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_trespasos = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 5 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    ...
                    $sql_total_rango_trespasos = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 5 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_radial26_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 7 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha ORDER BY fecha");
                    $sql_total_rango_am_radial26 = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 7 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    ...
                    $sql_total_rango_radial26 = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 7 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_qdelivilla_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 8 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_qdelivilla = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 8 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_qdelivilla = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 8 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_qdelivilla = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 8 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_bajio_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 9 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_bajio = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 9 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_bajio = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 9 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_bajio = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 9 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_total_rango_am_arenal = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 10 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_arenal = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 10 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_arenal = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 10 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_plan_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 11  AND fecha  BETWEEN '$fechaInicio' AND '$fechaFin'   AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_plan = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 11 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    ...
                    $sql_total_rango_plan = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 11 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_villa_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 13 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_villa = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 13 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_villa = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 13 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_villa = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 13 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_cinecenter_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 15 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_cinecenter = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 15 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_cinecenter = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 15 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_cinecenter = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 15 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_boulevar_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 16 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_boulevar = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 16 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_boulevar = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 16 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_mutu_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 14 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_mutu = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 14 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_mutu = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 14 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_mutu = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 14 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_roca_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 12 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_roca = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 12 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_roca = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 12 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_roca = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 12 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_total_rango_am_palmas = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 4 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_palmas = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 4 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_palmas = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 4 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                    ...
                    $sql_paragua_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 3 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_paragua = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 3 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    $sql_total_rango_pm_paragua = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 3 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_paragua = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 3 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");


                    $total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id BETWEEN 2 AND 16 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha;");
                    $total_rango = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND sucursal_id BETWEEN 2 AND 16");
                } else {
                    ...
                    // $sql_pm_radial26 = $db->GetAll("SELECT sum(total) AS total, fecha FROM venta WHERE sucursal_id = 7 AND fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND turno = 2 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_radial26_total = $db->GetAll("SELECT sum(total) AS total FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id = 7 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha");
                    $sql_total_rango_am_radial26 = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 7 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 1");
                    // $sql_total_rango_pm_radial26 = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 7 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND turno = 2");
                    $sql_total_rango_radial26 = $db->GetOne("SELECT sum(total) AS total FROM venta WHERE sucursal_id = 7 AND estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal'");
                ...
                <table id="tblventas" class="table table-striped table-hover table-bordered" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="background-color: #D9EDFC;">PM</td>
                            <?php foreach ($sql_pm_trespasos as $dato) { ?>
                                <?php if (number_format($dato['total'], 2) != 0 || number_format($dato['total'], 2) != null) { ?>
                                    <td style="background-color: #D9EDFC;"><?= number_format($dato['total'], 2, ',', '.')  ?></td>
                                <?php } else { ?>
                                    <td style="background-color: #D9EDFC;">-</td>
