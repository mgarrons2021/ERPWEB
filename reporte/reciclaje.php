...
from reciclaje t,usuario u
where t.usuario_id=u.idusuario  and t.Fecha between '$min' and '$max' ORDER BY t.idreciclaje DESC");
}
else{
...
<tr   class=warning>
  ...
  <td><?php echo $r["fecha"]; ?></td>
    <td><?php echo $r["usuario"]; ?></td>
     ...
     <td><?php  if($r["descripcion"]=="2"){echo "Sin Reciclaje";}else{echo "Reciclaje";}; ?></td>
 ...
 <div class="modal fade" id="ver<?php echo $r["nro"];echo $r["sucursal_id"];?>" 
                 ...
                 <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Detalle Reciclaje <?php echo $r["nro"]; ?></h4>
                  </div>
...
from detallereciclaje dt,producto p ,unidad_medida u
where  dt.nro = $r[nro] and p.idunidad_medida=u.idunidad_medida and p.idproducto = dt.producto_id and dt.sucursal_id=$r[sucursal_id]");
 ...
 <?php }?>
   ...
   <table id="usuario" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
   <tr>
   <td><h4>Total Reciclaje</h4></td><td><h4> <?php echo number_format($total,2)." bs"; ?></h4>
   </td></tr>
   </table>
  </div>
  </div>
