...
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 1 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 1 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 2 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 3 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 4 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 5 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 6 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 7 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 8 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 9 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 10 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 11 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 12 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 13 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 14 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 15 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 16 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 16 and fecha BETWEEN '$min' and '$max');");
$query_bodega = $db->GetAll("select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='diario' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 1 and i.nro = (select MAX(nro) 
...
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 1 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 1 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 2 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 2 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 3 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 3 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 4 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 4 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 5 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 5 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 6 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 6 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 7 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 7 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 8 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 8 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 9 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 9 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 10 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 10 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 11 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 11 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 12 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 12 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 13 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 13 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 14 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 14 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 15 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 15 and fecha BETWEEN '$min' and '$max')
UNION
select i.*, s.nombre as sucursal
from
inventario i,sucursal s
where
i.estado='semanal' and i.sucursal_id = s.idsucursal and i.Fecha between '$min' and '$max' and i.sucursal_id = 16 and i.nro = (select MAX(nro) 
    from inventario where sucursal_id = 16 and fecha BETWEEN '$min' and '$max');"); 
}
}
else{
...
<div class="">
   ...
   <thead>
    <tr>
            ...
            <th>Total-Inventario-Bodega </th>
            <th>Total-Inventario-Sucursales</th>
            <th>Total-Inventario</th>
            </tr>
</thead>
<tbody>
...
<tr>
  <td><h2><?php echo number_format($totalbodega,2)." bs."; ?></h2></td>
<td><h2><?php echo number_format($total - $totalbodega,2)." bs."; ?></h2></td>
<td><h2><?php echo number_format($total,2)." bs."; ?></h2></td>
