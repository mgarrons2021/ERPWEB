        ...
        <div class="left-sidebar">
            ...
            <div class="table-responsive">
                    ...
                    $(document).ready(function() {
                        $("#usuario").DataTable({
                            language: {
                                ...
                                oAria: {
                                    sSortending: ": Activar para ordenar la columna de manera endente",
                ...
                if (isset($_POST['fechaini']) && isset($_POST['fechamax'])) {
                    ...
                    $fecha = $db->GetAll("SELECT fecha FROM 
                     WHERE  fecha BETWEEN '$fechaInicio' AND '$fechaFin'  GROUP BY fecha;");                   
                    ...
                    $sql_Sur = $db->GetAll("SELECT TIME_FORMAT(sum(hora), '%T') as hora, sum(cantidad_bolsas) as cantidad  FROM registro_taxi WHERE sucursal_id = 2 and fecha BETWEEN '$fechaInicio' and '$fechaFin' GROUP by fecha;");
