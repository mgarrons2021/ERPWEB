        ...
        <div class="left-sidebar">
            ...
            <div class="table-responsive">
                ...
                if (isset($_POST['fechaini']) && isset($_POST['fechamax'])) {
                    ...
                    $total = $db->GetAll("SELECT sum(total) AS total, fecha FROM venta WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND sucursal_id BETWEEN 2 AND 16 AND pago != 'comida_personal' AND estado = 'V' GROUP BY fecha;");
                    $total_rango = $db->GetOne("SELECT sum(total) AS total, fecha FROM venta WHERE estado = 'V' AND fecha BETWEEN '$fechaInicio' AND '$fechaFin ' AND pago != 'comida_personal' AND sucursal_id BETWEEN 2 AND 16");
                } else {
