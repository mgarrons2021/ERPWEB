...
<head>
    ...
    <link rel="stylesheet" href="../pago/nota_pago/style.css">
</head>
...
<body>
    ...
    $datos = $db->Execute("SELECT  pro.empreza as Empreza, pro.nit, pro.celular, pro.codigo, c.fecha  
    FROM compra c 
        ...
        <table id="factura_head">
            <tr>
                <td class="logo_factura">
                    <div>
                        <img src="../pago/nota_pago/img/Logo_Correo.jpg" height="30%;" width="200px;">
                    </div>
                </td>
