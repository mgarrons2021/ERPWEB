...
function nro_factura(){$.post('nro_factura.php',function(valor){
  $('#nro_factura').val(valor);}
    ...
    $('#listado').load('listar.php',{"sucur":$('#sucur').val()
    });}
...
<div class="container">
  <div class="left-sidebar">
    <h2> INVENTARIO IDEAL <br> <?php echo $db->GetOne("select nombre from sucursal where idsucursal=".$sucur);?></h2>
     <h4><a href="lis_sucur.php">Atras</a></h4>
	<div class="">
          ...
          <div class="row">
              <div class="col-md-1">
               ...
               <input type="text" name="nro" id="nro" class="alert alert-info"
                ...
                <input type="hidden" name="sucur" id="sucur" value="<?php echo "$sucur"; ?>">
