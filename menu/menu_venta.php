...
<div class="header-bottom">
		...
		<div class="mainmenu pull-left">
			<ul class="nav navbar-nav collapse navbar-collapse">	
			    <li class="dropdown"><a href="#">LISTAR TURNOS<i class="fa fa-angle-down"></i></a>
                    <ul role="menu" class="sub-menu">                        
				        <li><a href="../turno/index.php">Listar</a></li>
			        </ul>
                </li>
           </ul>		
		</div>
		...
		<div class="mainmenu pull-left">
			<ul class="nav navbar-nav collapse navbar-collapse">	
			    <li class="dropdown"><a href="#">LISTAR VENTAS<i class="fa fa-angle-down"></i></a>
                    <ul role="menu" class="sub-menu">                        
				        <li><a href="../ventas/index.php">listar</a></li>
			        </ul>
                </li>
           </ul>		
		</div>
