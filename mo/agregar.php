...
if($turno=="0"){
   ...
   $insertar = $db->Execute("insert into registrar(nro,fecha,ventas,horas,totalhoras,porcentaje,turno,sucursal_id,usuario_id,funcionario)
   VALUE ('$nro','$fecha','$ventas','$horas','$totalhoras','$porcentaje','$turno','$usuario[sucursal_id]','$usuario[idusuario]','$funcionario',)");
