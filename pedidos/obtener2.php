...
$sql1 = $db->Execute("update detallepedido set cantidad_envio=$cantidad, subtotal_envio=$subtotal where iddetallepedido=$id");
}
$total2=0;
...
print "<script>alert(\"Se envio Exitosamente.\");window.location='env_dir.php';</script>";
}
else{
print "<script>alert(\"No se pudo Realizar los envios.\");window.location='env_dir.php';</script>";
}
?>