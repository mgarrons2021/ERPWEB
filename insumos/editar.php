...
<head>
  ...
  <script language="javascript">
    function nro_factura() {
      $.post('nro_factura.php', function(valor) {
        ...
        <form method="post" action="actualizar.php">
          <div class="row">
            <div class="col-md-1">
              ...
              <input type="text" name="nro" id="nro" class="alert alert-info" value="<?php echo "$nro"; ?>" disabled>
              <input type="hidden" name="nro" id="nro" value="<?php echo "$nro"; ?>">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              ...
              <input type="number" name="cantidad" id="cantidad" class="form-control" onkeypress="return validar(event)" value="" onChange="restar();">
            </div>
            <div class="col-md-2">
              <label>.</label>
