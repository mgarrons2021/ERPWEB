...
$db->AutoExecute('detalleproduccion', $fila, 'INSERT');

$produccion = $db->Execute("SELECT * from detalleproduccion where nro = '$_nro'and sucursal_id= '$sucur'");
echo '
<div class="container">
...
foreach($produccion as $reg) {
  ...
  <td><a href="javascript:eliminar('. $reg['iddetalleproduccion'] .')">Eliminar</a></td>
  </tr>';
  $total += $reg['subtotal'];
}
echo '<tr>
