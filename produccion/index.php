 ...
 <div class="modal fade" id="ver<?php echo $r["nro"];?>"
                 ...
                 <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Detalle insumos vendidos <?php echo $db->GetOne('SELECT nombre FROM sucursal where idsucursal = '.$r['sucursal_id']); ?> </h4>
                  </div>
...
from detalleproduccion dt,producto p ,unidad_medida u
where  dt.nro = $r[nro] and p.idunidad_medida=u.idunidad_medida and p.idproducto = dt.producto_id and dt.sucursal_id=".$sucur);
