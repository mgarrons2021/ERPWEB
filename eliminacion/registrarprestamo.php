...
$fila['observacion'] = $_observacion;
$fila['producto_id'] = $_producto;
$fila['sucursal_id'] = $sucur;
$db->AutoExecute('detalleeliminacion', $fila, 'INSERT');
$traspasos = $db->Execute("SELECT * from detalleeliminacion where nro = '$_nro'and sucursal_id= '$sucur'");
echo '
<div class="container">
...
foreach($traspasos as $reg) {
  ...
  <td><a href="javascript:eliminar('. $reg['iddetalleeliminacion'] .')">Eliminar</a></td>
  </tr>';
  $total += $reg['subtotal'];
}
echo '<tr>
