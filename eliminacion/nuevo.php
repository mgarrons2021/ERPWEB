...
$nro=$db->GetOne("select count(sucursal_id)+1 from  eliminacion where sucursal_id='$sucur'");
 if ($nro == ''){ $nro = 0;$nro++; } 
...
<div class="container">
  <div class="left-sidebar">
    <h2>Registro de nueva Eliminacion</h2>
	<div class="">
<form method="post" action="agregar.php">
          <div class="row">
              <div class="col-md-1">
                <label for="">Eliminacion:</label>
           ...
           <div class="row">
             <div class="col-md-2">
              <div class="input-group">
               <select class="btn btn-info" name="obs" id="obs" onChange="obse();">
                ...
                <option value="2"> Sin Eliminacion</option>
               </select>
             </div>
            ...
            <div class="col-md-2">
              ...
              <div class="input-group">
               ...
               <select class="btn btn-info" name="turno" id="turno" onChange="">
