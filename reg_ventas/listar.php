...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-10" align="center">
     ...
     <h2>ventas registradas <br><?php echo $sucursal;?></h2>
    </div>
    <div class="col-md-1">
...
<?php foreach ($query as $r){?>
  ...
  <td><?php echo $r["total"];?></td>
   <td style="width:210px;">
    ...
    <a href="editar.php?id_v=<?php echo $r["idreg_ventas"];?>"><img src="../images/edit.png" alt="" title="Modificar">Edit</a>
    <a href="eliminar.php?id=<?php echo $r["idreg_ventas"];?>"><img src="../images/eliminar.jpg" alt="" title="eliminar"> eliminar</a>
  </td>
  </tr>
 <?php }?>       
  </table>
