...
<form class="form-horizontal" data-toggle="validator" name="elformulario"  role="" action="agregar.php" method="post">
    <h2>registro de ventas <br> <?php echo $sucursal;?></h2>
       ...
       <input type="hidden" name="idsucursal" id="idsucursal" value="<?php echo "$sucursal_id"; ?>">
         ...
         <div class="col-md-12">
          <label class="col-md-5 control-label">GASEOSAS (Bebidas):</label>  
            <div class="col-md-2">
            <input id="gaseosas" type="decimal" name="gaseosas" class="form-control input-md" placeholder="bs.">
          </div>
         </div>
 ...
 <div class="col-md-12">
            ...
            <div class="col-md-2">
            <input id="plato_servido" type="decimal" name="plato_servido" class="form-control input-md" placeholder="bs." pattern="[z0-9_.]{1,15}">
            </div>
            </div>
            ...
            <div class="col-md-2">
            <input id="hamburguesas" type="decimal" name="hamburguesas" class="form-control input-md" placeholder="bs." pattern="[z0-9_.]{1,15}">
            </div>
            </div>
            ...
            <div class="col-md-2">
            <input id="delivery" type="decimal" name="delivery" class="form-control input-md" placeholder="bs." pattern="[z0-9_.]{1,15}">
            </div>
            </div>
            ...
            <div class="col-md-2">
            <input id="platos" type="decimal" name="platos" class="form-control input-md" placeholder="bs." pattern="[z0-9_.]{1,15}">
            </div>
            </div>
            ...
            <div class="col-md-2">
            <input id="kl" type="decimal" name="kl" class="form-control input-md" placeholder="bs." pattern="[z0-9_.]{1,15}">
            </div>
            </div>
            ...
            <div class="col-md-2">
            <input id="porciones" type="decimal" name="porciones" class="form-control input-md" placeholder="bs." pattern="[z0-9_.]{1,15}">
            </div>
            </div>
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-2">
            <input id="refrescos" type="decimal" name="refrescos" class="form-control input-md" placeholder="bs." pattern="[z0-9_.]{1,15}">
            </div>
            </div>
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-2">
            <input id="venta_externa" type="decimal" name="venta_externa" class="form-control input-md" placeholder="bs." pattern="[z0-9_.]{1,15}" >
            </div>
          ...
          <label class="col-md-5 control-label">.</label> 
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-2">
            <input id="transacciones" type="number" name="transacciones" class="form-control input-md" pattern="[z0-9_.]{1,15}">
            </div>
            </div>
         </div>
       <br> 
