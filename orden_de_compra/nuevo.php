...
$nro=$db->GetOne("select count(sucursal_id)+1 from  orden_de_compra where sucursal_id='$sucur'");
            ...
            <div class="col-md-3">
              <label>Empresa:</label>
               <div class="input-group">
                <input type="text" name="codigoproveedor" id="codigoproveedor"
                class="form-control"
                 placeholder="Nombre proveedor" disabled >
             ...
             <div class="col-md-3">
              ...
              <label>Producto:</label>
               <select class="form-control" name="idprod" id="idprod">
                ...
                if($i==7){echo "-----PLASTICOS-----";}?></h2></option>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" >
          ...
          <h4 class="modal-title" align="center">Lista de provedores</h4>
        </div>
