...
$nro=$db->GetOne("select count(sucursal_id)+1 from parte_produccion where sucursal_id='$sucur'");
 if ($nro == ''){ $nro = 0;$nro++; } 
...
<head>
    ...
    <title>Parte de Produccion</title>
...
<body onLoad="listar();">
    ...
    <h2>Registro Parte de Produccion</h2>
	  <div class="">
...
<!--fin de proveedor-->
       ...
       <div class="row">
            ...
            <div class="col-md-2">
              <label>Cantidad a Utilizada:</label>
